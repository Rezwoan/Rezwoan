...
_🕐 Last updated: Aug 27, 2026_

| | |
|---|---|
| **🌐 [omarchy-predator-performance](https://github.com/Rezwoan/omarchy-predator-performance)**<br/>Omarchy omarchy-shell plugin: power/CPU/GPU/battery/keyboard<br/>`QML` ⭐ 0 🍴 0 | **🌐 [omarchy-setup](https://github.com/Rezwoan/omarchy-setup)**<br/>My Omarchy (Arch+Hyprland) setup — configs, keybindings, a n<br/>`Shell` ⭐ 1 🍴 0 |
...
| **🌐 [RepRush-web](https://github.com/Rezwoan/RepRush-web)**<br/>Self-hostable gym-tracking PWA — NestJS + Next.js + SQLite, <br/>`Misc` ⭐ 0 🍴 0 | **🌐 [CrisisConnect-Backend](https://github.com/Rezwoan/CrisisConnect-Backend)**<br/>_No description_<br/>`TypeScript` ⭐ 1 🍴 0 |
