...
_🕐 Last updated: Aug 10, 2026_

| | |
|---|---|
| **🌐 [RepRush-web](https://github.com/Rezwoan/RepRush-web)**<br/>Self-hostable gym-tracking PWA — NestJS + Next.js + SQLite, <br/>`TypeScript` ⭐ 0 🍴 0 | **🌐 [omarchy-setup](https://github.com/Rezwoan/omarchy-setup)**<br/>My Omarchy (Arch+Hyprland) setup — configs, keybindings, a n<br/>`Shell` ⭐ 1 🍴 0 |
...
| **🌐 [BloodBankDB](https://github.com/Rezwoan/BloodBankDB)**<br/>_No description_<br/>`HTML` ⭐ 0 🍴 0 |  |
